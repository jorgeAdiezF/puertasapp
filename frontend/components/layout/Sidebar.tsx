  ...
  return (
    <aside className="w-64 bg-gray-900 text-white flex flex-col min-h-screen">
      ...
      <div className="px-6 py-5 border-b border-gray-700">
        <h1 className="text-lg font-bold text-white">Portal Puertas</h1>
        <p className="text-xs text-gray-400 mt-0.5">Gestión Técnica</p>
      </div>
      ...
      <div className="px-3 py-4 border-t border-gray-700">
        <div className="px-3 py-2 mb-2">
          ...
          <p className="text-xs text-gray-400 capitalize">{usuario?.perfil?.replace('_', ' ')}</p>
        </div>
        <button
